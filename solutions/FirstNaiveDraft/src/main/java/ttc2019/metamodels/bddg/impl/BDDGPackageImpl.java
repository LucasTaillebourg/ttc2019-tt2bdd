...
public class BDDGPackageImpl extends EPackageImpl implements BDDGPackage {
	...
	public static BDDGPackage init() {
		if (isInited) return (BDDGPackage) Registry.INSTANCE.getEPackage(BDDGPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredBDDGPackage = Registry.INSTANCE.get(eNS_URI);
		...
		Registry.INSTANCE.put(BDDGPackage.eNS_URI, theBDDGPackage);
