...
public class TTPackageImpl extends EPackageImpl implements TTPackage {
	...
	public static TTPackage init() {
		if (isInited) return (TTPackage) Registry.INSTANCE.getEPackage(TTPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredTTPackage = Registry.INSTANCE.get(eNS_URI);
		...
		Registry.INSTANCE.put(TTPackage.eNS_URI, theTTPackage);
		return theTTPackage;
	}
