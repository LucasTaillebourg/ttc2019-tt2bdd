...
public interface Tree extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link BDD#getTrees <em>Trees</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see #setOwnerBDD(BDD)
	 * @see BDDGPackage#getTree_OwnerBDD()
	 * @see BDD#getTrees
	 ...
	 * @see BDDGPackage#getTree_OwnerSubtreeForZero()
	 ...
	 * @see BDDGPackage#getTree_OwnerSubtreeForOne()
